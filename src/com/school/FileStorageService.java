...
public class FileStorageService {
	...
	public void saveData(List<? extends Storable> items, String filename) {
		...
		try (PrintWriter writer = new PrintWriter(new FileWriter(filename))) { // List<? extends Storable> items
											// → A list of objects that
											// implement the Storable
											// interface.
											// ✅ This ensures every object
											// passed here knows how to
											// convert itself into a string
											// (via toDataString() method).
